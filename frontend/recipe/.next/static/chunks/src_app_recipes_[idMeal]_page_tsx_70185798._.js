...
"[project]/src/app/recipes/[idMeal]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
// File: app/recipes/[idMeal]/page.tsx
...
async function fetchRecipesByCategory(category) {
    const listRes = await fetch(`${BACKEND_BASE}/recipes?category=${encodeURIComponent(category)}`, {
        cache: 'no-store'
    });
    if (!listRes.ok) throw new Error(`Failed to fetch list for category ${category}`);
    const listData = await listRes.json();
    if (!listData.meals) return [];
    const lookupPromises = listData.meals.map((m)=>fetch(`${BACKEND_BASE}/recipes/${m.idMeal}`, {
            cache: 'no-store'
        }).then((r)=>{
            if (r.status === 404) return null;
            if (!r.ok) throw new Error(`Lookup failed for ${m.idMeal}`);
            return r.json();
        }).then((resp)=>resp && resp.meals && resp.meals.length > 0 ? normalizeRawMeal(resp.meals[0]) : null));
        ...
        "RecipeInfoPage.useEffect": ()=>{
            ...
            async function loadData() {
                try {
                    ...
                    setRelated(fetchedRelated.filter({
                        "RecipeInfoPage.useEffect.loadData": (r)=>r.id !== fetchedRecipe.id
                    }["RecipeInfoPage.useEffect.loadData"]));
                } catch (err) {
    ...
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Box$2f$Box$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                fileName: "[project]/src/app/recipes/[idMeal]/page.tsx",
                lineNumber: 178,
                columnNumber: 9
            }, this)
        }, void 0, false, {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        href: `/recipes/country/${encodeURIComponent(recipe.country)}`,
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Typography$2f$Typography$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                            component: "a",
                                                            variant: "body1",
                                                            sx: {
...
_s(RecipeInfoPage, "iKulnv1brxYVPdgdgvzPVUx9V7k=", false, function() {
    return [
...
_c = RecipeInfoPage;
var _c;
__turbopack_context__.k.register(_c, "RecipeInfoPage");
...
//# sourceMappingURL=src_app_recipes_%5BidMeal%5D_page_tsx_70185798._.js.map